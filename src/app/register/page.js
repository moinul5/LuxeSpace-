...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setToast({ message: "Registration successful! Welcome to LuxeSpace.", type: "success" });
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      setToast({ message: "Google Sign-In successful! Welcome to LuxeSpace.", type: "success" });
      setTimeout(() => router.push("/"), 1500);
    } catch (err) {
      console.error(err);
    ...
    <div className="auth-page-wrapper">
      ...
      <div className="auth-card glass animate-fade-in">
        <div className="auth-header">
          ...
          <p>Join LuxeSpace to start publishing and managing items</p>
        </div>
